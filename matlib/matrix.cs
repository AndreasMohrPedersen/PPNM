...
public static matrix id(int n){//n,n simensional identity matrix
...
public void randomize()//randomize matrix
{
	var rnd = new Random();
 	for(int i=0; i<this.size1; i++)
 	{
		...
		{
			this[i,j] = rnd.NextDouble();//return a random float between 0.0 and 1.0
		}
 	}
}//randomize
public void randomSymmetric()//generates random symmetric matrix
{
	var rnd = new Random();
 	for(int i=0; i<this.size1; i++)
 	{
